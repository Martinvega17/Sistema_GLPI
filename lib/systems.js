...
// para TODOS los sistemas. Útil para ver el dashboard funcionando de
// inmediato, antes de habilitar la API REST en cada GLPI y confirmar los
// App-Tokens.
...
export const SYSTEMS = [
  ...
  },
  {
    ...
    // Todavía no hay una instancia GLPI real conectada para IMSS. Como
    // baseUrl queda vacío mientras no se configure GLPI_IMSS_URL,
    // isSystemDemo() (abajo) usa datos de ejemplo automáticamente para este
    // sistema — sin afectar a los demás, que pueden seguir en modo real
    // aunque DEMO_MODE global sea false. En cuanto llenen GLPI_IMSS_URL (y
    // sus tokens) en .env.local, pasa a real sin tocar código.
  },
];

// Un sistema opera en modo demo si el modo demo global está prendido, o si
// le falta la URL base (no hay a quién preguntarle todavía).
