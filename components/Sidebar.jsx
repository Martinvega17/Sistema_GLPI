...
// Iconos por sistema (uno por institución/proyecto).
            ...
            >
              <div className="h-6 w-6 rounded-full bg-base-700 flex items-center justify-center shrink-0 overflow-hidden">
                {icon ? (
                  ...
                  <span className="text-[11px] font-mono">{sys.label[0]}</span>
                )}
              </div>
              {!collapsed && <span className="flex-1 text-left truncate">{sys.label}</span>}
