...
"[project]/app/api/report/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toCsv(tickets, { includeFirstResponse = false } = {}) {
    ...
    const rows = tickets.map((t)=>{
        ...
        if (includeFirstResponse) {
            row.push(t.firstResponseDate || "", t.firstResponseHours != null ? Math.round(t.firstResponseHours * 60) : "");
        }
        return csvRow(row);
    });
...
async function attachFirstResponseTimes(tickets) {
    ...
    await Promise.all(Object.entries(bySystemId).map(async ([systemId, sysTickets])=>{
        ...
        const dates = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$glpiClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFirstResponseForTickets"])(system, sysTickets.map((t)=>t.rawId));
...
async function GET(request) {
    ...
    const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ticketSource$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchAllSystemResults"])();
    ...
    if (format === "csv") {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](csv, {
            headers: {
                ...
                "Content-Disposition": `attachment; filename="reporte-tickets-${new Date().toISOString().slice(0, 10)}.csv"`
            }
        });
    }
    const topOverdue = tickets.filter((t)=>t.slaStatus === "breach").sort((a, b)=>(b.ageHours || 0) - (a.ageHours || 0)).slice(0, 10);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d66lkr._.js.map