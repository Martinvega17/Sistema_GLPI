...
"[project]/app/api/project-tickets/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$categories$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/categories.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ticketSource$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ticketSource.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ticketEnrichment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ticketEnrichment.js [app-route] (ecmascript)");
...
async function GET(request) {
    ...
    const category = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$categories$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCategory"])(categoryId);
    if (!category) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Categoría desconocida: ${categoryId}`
        }, {
            status: 404
        });
    }
    ...
    const systems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$categories$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["systemsForCategory"])(categoryId);
    const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ticketSource$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchAllSystemResults"])(systems);
    ...
    const { tickets: evaluated, totals, bySystem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sla$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["summarize"])(allTickets);
    const filtered = evaluated.filter((t)=>systemFilter === "all" ? true : t.systemId === systemFilter).filter((t)=>{
    ...
    const enrichedGroups = await Promise.all([
        ...ticketsBySystem.entries()
    ].map(async ([systemId, ticketsForSystem])=>{
        const system = systems.find((s)=>s.id === systemId);
        if (!system || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systems$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSystemDemo"])(system)) return ticketsForSystem;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ticketEnrichment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrichTicketsWithDetails"])(system, ticketsForSystem);
    }));
...
"[project]/lib/categories.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function systemsForCategory(categoryId) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systems$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYSTEMS"].filter((s)=>idSet.has(s.id));
}
...
function dispatcherFor(system) {
    ...
    if (!insecureAgent) {
        const { Agent } = __turbopack_context__.r("[project]/node_modules/undici/index.js [app-route] (ecmascript)");
...
"[project]/lib/ticketEnrichment.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "enrichTicketsWithDetails",
    ()=>enrichTicketsWithDetails
]);
...
async function enrichTicketsWithDetails(system, tickets, { concurrency = 4 } = {}) {
    return mapWithConcurrency(tickets, concurrency, async (ticket)=>{
        ...
        const detail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$glpiClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchTicketDetail"])(system, ticket.rawId);
        if (!detail.ok) {
...
"[project]/lib/ticketSource.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "fetchAllSystemResults",
    ()=>fetchAllSystemResults
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systems$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/systems.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$glpiClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/glpiClient.js [app-route] (ecmascript)");
...
;
;
async function fetchAllSystemResults(systems = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systems$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYSTEMS"]) {
    return Promise.all(systems.map((system, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$systems$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSystemDemo"])(system) ? Promise.resolve((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demoData$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildDemoResultForSystem"])(system, i)) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$glpiClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchTicketsForSystem"])(system)));
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1vjj1xn._.js.map