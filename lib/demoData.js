...
export function buildDemoResultForSystem(systemId) {
  // Usa tu función getDemoResults existente
  const resultados = getDemoResults();
  return resultados[systemId] || null;
